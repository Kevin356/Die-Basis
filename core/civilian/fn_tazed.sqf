...
if(_shooter isKindOf "Man" && alive player) then
{
	if(!life_istazed) then
	{
		...
		player playMoveNow "AinjPfalMstpSnonWnonDf_carried_fallwc";
		[0, "STR_NOTF_Tazed", true, [profileName, _shooter getVariable["realname",name _shooter]]] remoteExecCall ["life_fnc_broadcast", -2];
