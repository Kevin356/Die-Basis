...
if(count _invs > 0) then
{
	...
	{
		[getPlayerUID _civ, _civ getVariable["realname", name _civ], "482"] remoteExecCall ["life_fnc_wantedAdd", 2];
	};
	
	[getPlayerUID _civ, _civ getVariable["realname",name _civ], "481"] remoteExecCall ["life_fnc_wantedAdd", 2];
