...
_filter lbAdd localize "STR_CRAFT_FILTER_Vests";
_filter lbSetData[(lbSize _filter)-1,"vests"];
_filter lbAdd localize "STR_CRAFT_FILTER_Attachments";
_filter lbSetData[(lbSize _filter)-1,"attachments"];
_filter lbAdd localize "STR_CRAFT_FILTER_Magazines";
_filter lbSetData[(lbSize _filter)-1,"magazines"];
