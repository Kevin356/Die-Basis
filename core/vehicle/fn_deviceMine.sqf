...
_resourceZones = ["uranium_1","reifen_1","gold_1","silber_1","wood_1","baumwolle_1","cocaine_2","apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","roggen","hopfen","hefe","trauben","meth_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["hopfen"]): {"hopfen"};
	case (_zone in ["hefe"]): {"hefe"};
	case (_zone in ["roggen"]): {"roggen"};
	case (_zone in ["baumwolle_1"]): {"baumwolleu"};
	case (_zone in ["wood_1"]): {"holzu"};
	case (_zone in ["meth_1"]): {"methu"};
	case (_zone in ["silber_1"]): {"silberu"};
	case (_zone in ["gold_1"]): {"goldu"};
	case (_zone in ["reifen_1"]): {"reifenu"};
	case (_zone in ["trauben"]): {"trauben"};
	case (_zone in ["uranium_1"]): {"uranium_1"};
	default {""};
};
