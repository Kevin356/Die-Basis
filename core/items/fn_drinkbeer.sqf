...
if (life_drink > 0.22) then {
			...
			[0, format[localize "STR_MISC_StPubIntox", profileName]] remoteExecCall ["life_fnc_broadcast", -2];
			[getPlayerUID player, profileName, "390"] remoteExecCall ["life_fnc_wantedAdd", 2];
