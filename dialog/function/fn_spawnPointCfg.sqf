...
switch (_side) do
{
	case west:
	{
		...
		_return = [
					...
					["cop_spawn_3","FlughafenHQ","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"],
	...
	case civilian:
	{
		...
		_return = [
					...
					["civ_spawn_flug","Flughafen","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
	...
	case independent: {
		_return = [
			["medic_spawn_1","Krankenhaus HQ","\a3\ui_f\data\map\MapControl\hospital_ca.paa"],
			["medic_spawn_2","EHS Luftstützpunkt","\a3\ui_f\data\map\MapControl\hospital_ca.paa"],
			["medic_spawn_1_1","Pyrgos EHS","\a3\ui_f\data\map\MapControl\hospital_ca.paa"],
			["medic_spawn_1_1_1","Sofia EHS","\a3\ui_f\data\map\MapControl\hospital_ca.paa"],
			["adac_spawn_1","EHS HQ","\a3\ui_f\data\map\Markers\NATO\b_air.paa"],
			["adac_spawn_2","EHS Ost HQ","\a3\ui_f\data\map\Markers\NATO\b_air.paa"]
		];
	};
};
